...
A browser build is published on itch.io: [bitona.itch.io/dronesim](https://bitona.itch.io/dronesim) *(currently in draft — the page isn't visible until published)*.
