...
- [ ] **A — GitHub upstream**: `README.md` (user-facing intro), MIT `LICENSE`,
...
- [ ] **B — itch.io web export (Draft)**: `export_web.sh` (headless
...
- [ ] **C — doc-comments pass**: GDScript `##` doc comments across
  ...
  locally once.
- [ ] **D — telemetry logging (no playback)**: new
...
- [ ] **E — GitHub Pages generated docs**: CI docs job — doctool XML from the
